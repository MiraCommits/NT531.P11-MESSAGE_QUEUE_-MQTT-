...
set nf [open scenario4c-SFQ.nam w]
$ns namtrace-all $nf

#open the trace file
set tf [open scenario4c-SFQ.tr w]
$ns trace-all $tf
...
$ns duplex-link $n0 $n4 10Mb 20ms SFQ
$ns duplex-link $n1 $n4 10Mb 20ms SFQ
$ns duplex-link $n2 $n4 10Mb 20ms SFQ
$ns duplex-link $n3 $n4 100Mb 20ms SFQ
$ns duplex-link $n4 $n5 5Mb 20ms SFQ
